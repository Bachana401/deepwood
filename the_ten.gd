...
const ROSTER = {
	"ten_brannoc": {"floor": 22, "name": "Brannoc", "title": "the Wall That Stood",
	...
	"ten_maera": {"floor": 26, "name": "Maera", "title": "the Last Lightmender",
	...
	"ten_toren": {"floor": 38, "name": "Toren Ashvale", "title": "the Forgefather",
	...
	"ten_sylvara": {"floor": 31, "name": "Sylvara", "title": "Warden of the Old Groves",
	...
	"ten_kaldos": {"floor": 34, "name": "Kaldos", "title": "the Tidecaller",
	...
	"ten_elenwe": {"floor": 53, "name": "Elenwe", "title": "Archivist of the Broken Age",
	...
	"ten_dorian": {"floor": 43, "name": "Dorian Vail", "title": "the Coinbinder",
	...
	"ten_mirielle": {"floor": 47, "name": "Mirielle", "title": "Voice of the Old Crown",
	...
	"ten_seraphel": {"floor": 58, "name": "Seraphel", "title": "the Lightkeeper",
	...
	"ten_ilo": {"floor": 63, "name": "Ilo", "title": "the Nameless Bard",

...
const ROWS = [
	...
	["wpn_worldtoll",    "Worldtoll Maul",       "melee", 5, "cleave",    36, 1.1,  {"knockup": true, "plain": true}],
	...
	["wpn_skyquill",     "Sky of Quills",        "spear", 5, "jab_volley", 18, 0.9, {"count": 5, "plain": true}],
	["wpn_eventide",     "Eventide",             "bow",   5, "volley",    15, 0.55, {"count": 3, "plain": true}],
	...
	["wpn_starfallbow",  "Starfall Bow",         "bow",   5, "lob_a",     30, 1.0,  {"aoe": 115, "plain": true}],
	...
	["wpn_hushfall",     "Hushfall",             "melee", 6, "cleave",    44, 1.1,  {"knockup": true, "status": "slow_w", "plain": true}],
	...
	["wpn_meteorquill",  "Meteor Quills",        "spear", 6, "jab_volley", 23, 0.88, {"count": 5, "status": "burn_w", "plain": true}],
	["wpn_middaybow",    "Midday Massacre",      "bow",   6, "volley",    19, 0.52, {"count": 4, "plain": true}],
	...
	["wpn_stormherd",    "Stormherd",            "spear", 5, "jab_volley", 17, 0.88, {"count": 5, "plain": true}],
	["wpn_moonreach",    "Moonreach",            "spear", 5, "thrust",    23, 0.58, {"status": "slow_w", "plain": true}],
	["wpn_kestrelbow",   "Kestrel's Court",      "bow",   5, "volley",    14, 0.54, {"count": 3, "plain": true}],
	["wpn_quillrain",    "Quillrain",            "bow",   5, "rapid",     10, 0.16, {"plain": true}],
	...
	["wpn_glacierwrit",  "Glacier Writ",         "wand",  5, "frost",     24, 0.55, {"status": "slow_w", "plain": true}],
	...
	["wpn_emberhymn",    "Emberhymn",            "wand",  5, "fire",      30, 0.82, {"aoe": 130, "status": "burn_w", "plain": true}],
	...
	["wpn_nightmortar",  "Midnight Post",        "bow",   5, "lob_a",     27, 0.95, {"aoe": 105, "plain": true}],
	...
	["wpn_worldanvil",   "The World-Anvil",      "melee", 6, "cleave",    42, 1.08, {"knockup": true, "plain": true}],
	...
	["wpn_ashherd",      "Herd of Ashes",        "spear", 6, "jab_volley", 22, 0.86, {"count": 5, "status": "burn_w", "plain": true}],
	["wpn_griffvolley",  "Griffin Volley",       "bow",   6, "volley",    18, 0.5,  {"count": 4, "plain": true}],
	["wpn_silentchoir",  "The Silent Choir",     "bow",   6, "rapid",     13, 0.15, {"plain": true}],
	...
	["wpn_permafrost",   "Permafrost Decree",    "wand",  6, "frost",     29, 0.54, {"status": "slow_w", "plain": true}],

...
const ROWS = [
	...
	["wpn_grandrains",   "Grand Tome of Rains",  "wand",  5, "tome",      14, 1.35, {"radius": 155, "fx": [{"kind": "crowd", "pct_per": 0.18, "cap": 0.7}, {"kind": "sparkfly", "n": 1, "pct": 0.6}]}],
	...
	["wpn_sirensbook",   "The Siren's Appendix", "wand",  5, "tome",      13, 1.35, {"radius": 150, "fx": [{"kind": "gravity", "radius": 230.0, "pull": 165.0}, {"kind": "duelist", "pct_per": 0.12, "max": 6}]}],

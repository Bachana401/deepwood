...
const ITEM_DEFS = {
	...
	"wpn_emberstaff": {
		...
		"special": {"type": "fireball", "damage": 24, "aoe": 110.0, "speed": 460.0, "range": 600.0, "status": {"kind": "burn", "dur": 4.0, "mag": 6.0}},
	...
	"wpn_iciclewand": {
		...
		"special": {"type": "frost_shard", "damage": 14, "speed": 640.0, "range": 560.0, "pierce": true, "status": {"kind": "slow", "dur": 3.0, "mag": 0.5}},
	...
	"wpn_tempest": {
		...
		"weapon_stats": {"damage": 14, "cooldown": 0.6, "range_offset": 90, "area_size": Vector2(110, 40), "knockback_min": 24.0, "knockback_max": 48.0, "icon_size": Vector2(15, 15), "icon_color": Color(0.5, 0.85, 1.0), "icon_offset": 18.0},
	...
	"exc_doom": {
		...
		"weapon_stats": {"damage": 18, "cooldown": 0.5, "range_offset": 50, "area_size": Vector2(66, 40), "knockback_min": 35.0, "knockback_max": 70.0, "icon_size": Vector2(60, 13), "icon_color": Color(0.62, 0.08, 0.16), "icon_offset": 20.0},
	...
	"exc_singularity": {
		...
		"weapon_stats": {"damage": 15, "cooldown": 0.5, "range_offset": 50, "area_size": Vector2(64, 38), "knockback_min": 20.0, "knockback_max": 40.0, "icon_size": Vector2(56, 12), "icon_color": Color(0.6, 0.32, 0.92), "icon_offset": 20.0},
	...
	"exc_worldsplitter": {
		...
		"weapon_stats": {"damage": 20, "cooldown": 0.5, "range_offset": 52, "area_size": Vector2(70, 42), "knockback_min": 45.0, "knockback_max": 85.0, "icon_size": Vector2(64, 14), "icon_color": Color(0.95, 0.6, 0.2), "icon_offset": 20.0},
	...
	"exc_dawnbreaker": {
		...
		"weapon_stats": {"damage": 15, "cooldown": 0.4, "range_offset": 48, "area_size": Vector2(64, 38), "knockback_min": 30.0, "knockback_max": 60.0, "icon_size": Vector2(56, 12), "icon_color": Color(1.0, 0.95, 0.6), "icon_offset": 20.0},
	...
	"wpn_club": {"name": "Wooden Club", "category": "weapon", "weapon_type": "melee", "max_stack": 1, "color": Color(0.55, 0.4, 0.24, 1.0),
		"weapon_stats": {"damage": 11, "cooldown": 0.35, "range_offset": 46, "area_size": Vector2(58, 34), "knockback_min": 35.0, "knockback_max": 65.0, "icon_size": Vector2(48, 14), "icon_color": Color(0.55, 0.4, 0.24), "icon_offset": 20.0}},
	"wpn_shortbow": {"name": "Short Bow", "category": "weapon", "weapon_type": "bow", "max_stack": 1, "color": Color(0.5, 0.34, 0.18, 1.0),
		"weapon_stats": {"damage": 12, "cooldown": 0.42, "range_offset": 90, "area_size": Vector2(110, 40), "knockback_min": 18.0, "knockback_max": 36.0, "icon_size": Vector2(14, 14), "icon_color": Color(0.5, 0.34, 0.18), "icon_offset": 18.0}},
	"wpn_apprentice_wand": {"name": "Apprentice Wand", "category": "weapon", "weapon_type": "wand", "max_stack": 1, "color": Color(0.55, 0.45, 0.85, 1.0), "mana_cost": 6,
		...
		"special": {"type": "frost_shard", "damage": 10, "speed": 560.0, "range": 480.0}, "unique_desc": "A starter caster's bolt of force."},
	"wpn_dagger": {"name": "Iron Dagger", "category": "weapon", "weapon_type": "melee", "max_stack": 1, "color": Color(0.75, 0.76, 0.82, 1.0),
		"weapon_stats": {"damage": 7, "cooldown": 0.22, "range_offset": 40, "area_size": Vector2(48, 32), "knockback_min": 15.0, "knockback_max": 30.0, "icon_size": Vector2(40, 10), "icon_color": Color(0.78, 0.78, 0.84), "icon_offset": 18.0},
	...
	"wpn_mace": {"name": "Iron Mace", "category": "weapon", "weapon_type": "melee", "max_stack": 1, "color": Color(0.6, 0.6, 0.66, 1.0),
		"weapon_stats": {"damage": 18, "cooldown": 0.6, "range_offset": 48, "area_size": Vector2(60, 38), "knockback_min": 55.0, "knockback_max": 95.0, "icon_size": Vector2(50, 16), "icon_color": Color(0.62, 0.62, 0.68), "icon_offset": 20.0},
	...
	"wpn_greatsword": {"name": "Greatsword", "category": "weapon", "weapon_type": "melee", "max_stack": 1, "color": Color(0.78, 0.78, 0.84, 1.0),
		"weapon_stats": {"damage": 22, "cooldown": 0.7, "range_offset": 54, "area_size": Vector2(78, 44), "knockback_min": 45.0, "knockback_max": 80.0, "icon_size": Vector2(70, 14), "icon_color": Color(0.8, 0.8, 0.86), "icon_offset": 20.0},
	...
	"wpn_katana": {"name": "Katana", "category": "weapon", "weapon_type": "melee", "max_stack": 1, "color": Color(0.85, 0.85, 0.9, 1.0),
		"weapon_stats": {"damage": 13, "cooldown": 0.32, "range_offset": 50, "area_size": Vector2(66, 34), "knockback_min": 28.0, "knockback_max": 55.0, "icon_size": Vector2(62, 10), "icon_color": Color(0.88, 0.88, 0.94), "icon_offset": 20.0},
	...
	"wpn_warhammer": {"name": "Warhammer", "category": "weapon", "weapon_type": "melee", "max_stack": 1, "color": Color(0.55, 0.5, 0.5, 1.0),
		"weapon_stats": {"damage": 30, "cooldown": 0.9, "range_offset": 52, "area_size": Vector2(72, 46), "knockback_min": 80.0, "knockback_max": 140.0, "icon_size": Vector2(56, 18), "icon_color": Color(0.58, 0.52, 0.52), "icon_offset": 20.0},
	...
	"wpn_javelin": {"name": "Javelin", "category": "weapon", "weapon_type": "spear", "max_stack": 1, "color": Color(0.62, 0.5, 0.3, 1.0),
		"weapon_stats": {"damage": 12, "cooldown": 0.7, "range_offset": 55, "area_size": Vector2(70, 40), "knockback_min": 35.0, "knockback_max": 65.0, "icon_size": Vector2(100, 7), "icon_color": Color(0.62, 0.5, 0.3), "icon_offset": 16.0},
		"special": {"type": "javelin_volley", "count": 1, "spread_deg": 0.0, "damage": 16, "speed": 720.0, "range": 560.0}, "unique_desc": "Hurl a single hard-piercing javelin instead of thrusting."},
	"wpn_harpoon": {"name": "Harpoon", "category": "weapon", "weapon_type": "melee", "max_stack": 1, "color": Color(0.4, 0.6, 0.62, 1.0),
		"weapon_stats": {"damage": 14, "cooldown": 0.75, "range_offset": 48, "area_size": Vector2(60, 36), "knockback_min": 0.0, "knockback_max": 0.0, "icon_size": Vector2(58, 9), "icon_color": Color(0.4, 0.6, 0.62), "icon_offset": 20.0},
		"special": {"type": "hook", "damage": 14, "speed": 820.0, "range": 460.0}, "unique_desc": "Spears a foe from range and reels it to you."},
	...
	"exc_earthshaker": {"name": "Earthshaker Maul", "category": "weapon", "weapon_type": "melee", "excellent": true, "max_stack": 1, "color": Color(0.7, 0.45, 0.2, 1.0),
		"weapon_stats": {"damage": 24, "cooldown": 0.7, "range_offset": 52, "area_size": Vector2(74, 44), "knockback_min": 70.0, "knockback_max": 120.0, "icon_size": Vector2(58, 18), "icon_color": Color(0.72, 0.46, 0.2), "icon_offset": 20.0},
	...
	"exc_gungnir": {"name": "Gungnir", "category": "weapon", "weapon_type": "spear", "excellent": true, "max_stack": 1, "color": Color(0.9, 0.85, 0.55, 1.0),
		"weapon_stats": {"damage": 14, "cooldown": 0.75, "range_offset": 55, "area_size": Vector2(70, 40), "knockback_min": 40.0, "knockback_max": 70.0, "icon_size": Vector2(112, 8), "icon_color": Color(0.9, 0.85, 0.55), "icon_offset": 16.0},
		"special": {"type": "javelin_volley", "count": 5, "spread_deg": 16.0, "damage": 16, "speed": 780.0, "range": 620.0},
	...
	"exc_shadowblade": {"name": "Shadowblade", "category": "weapon", "weapon_type": "melee", "excellent": true, "max_stack": 1, "color": Color(0.35, 0.28, 0.45, 1.0),
		"weapon_stats": {"damage": 12, "cooldown": 0.3, "range_offset": 46, "area_size": Vector2(58, 34), "knockback_min": 20.0, "knockback_max": 40.0, "icon_size": Vector2(52, 10), "icon_color": Color(0.55, 0.4, 0.75), "icon_offset": 20.0},
		"passive": {"crit_chance": 0.25, "crit_damage": 0.5}, "unique_effect": "radiance", "unique_value": 0.0,
		"unique_desc": "A blade of pure night: sky-high crit and a shadow-slash on every strike."},
	"exc_frostmourne": {"name": "Frostmourne", "category": "weapon", "weapon_type": "melee", "excellent": true, "max_stack": 1, "color": Color(0.55, 0.8, 0.95, 1.0),
		"weapon_stats": {"damage": 18, "cooldown": 0.45, "range_offset": 50, "area_size": Vector2(66, 38), "knockback_min": 30.0, "knockback_max": 60.0, "icon_size": Vector2(64, 12), "icon_color": Color(0.6, 0.82, 0.98), "icon_offset": 20.0},
	...
	"exc_voidcaller": {"name": "Voidcaller", "category": "weapon", "weapon_type": "wand", "excellent": true, "max_stack": 1, "color": Color(0.45, 0.2, 0.7, 1.0), "mana_cost": 16,
		...
		"special": {"type": "fireball", "damage": 42, "aoe": 180.0, "speed": 420.0, "range": 640.0, "status": {"kind": "poison", "dur": 5.0, "mag": 8.0}},
	...
	"exc_stormfury": {"name": "Stormfury Bow", "category": "weapon", "weapon_type": "bow", "excellent": true, "max_stack": 1, "color": Color(0.5, 0.8, 1.0, 1.0),
		"weapon_stats": {"damage": 16, "cooldown": 0.55, "range_offset": 90, "area_size": Vector2(110, 40), "knockback_min": 24.0, "knockback_max": 48.0, "icon_size": Vector2(15, 15), "icon_color": Color(0.5, 0.8, 1.0), "icon_offset": 18.0},

...
const ITEM_DEFS = {
	...
	"exc_chrono": {
		...
		"swing_slash": {"damage_mult": 0.50, "speed": 560.0, "range": 320.0},
	...
	"exc_ragnarok": {
		...
		"swing_slash": {"damage_mult": 0.60, "speed": 560.0, "range": 340.0, "status": {"kind": "burn", "dur": 3.0, "mag": 6.0}},
	...
	"exc_worldsplitter": {
		...
		"swing_slash": {"damage_mult": 0.60, "speed": 520.0, "range": 360.0},
	...
	"exc_frostmourne": {"name": "Frostmourne", "category": "weapon", "weapon_type": "melee", "excellent": true, "max_stack": 1, "color": Color(0.55, 0.8, 0.95, 1.0),
		...
		"swing_slash": {"damage_mult": 0.55, "speed": 540.0, "range": 330.0, "status": {"kind": "slow", "dur": 2.5, "mag": 0.45}},

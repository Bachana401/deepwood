...
const ITEM_DEFS = {
	...
	"evt_tiderender": {"name": "Tiderender", "category": "weapon", "weapon_type": "spear", "max_stack": 1, "color": Color(0.28, 0.62, 0.72, 1.0),
		"weapon_stats": {"damage": 16, "cooldown": 1.0, "range_offset": 55, "area_size": Vector2(70, 40), "knockback_min": 45.0, "knockback_max": 78.0, "icon_size": Vector2(84, 8), "icon_color": Color(0.28, 0.62, 0.72), "icon_offset": 16.0},
	...
	"evt_vigil": {"name": "Vigil Lance", "category": "weapon", "weapon_type": "spear", "max_stack": 1, "color": Color(0.7, 0.75, 0.9, 1.0),
		"weapon_stats": {"damage": 30, "cooldown": 0.95, "range_offset": 58, "area_size": Vector2(74, 42), "knockback_min": 55.0, "knockback_max": 92.0, "icon_size": Vector2(86, 9), "icon_color": Color(0.7, 0.75, 0.9), "icon_offset": 16.0},
	...
	"exc_gungnir": {"name": "Gungnir", "category": "weapon", "weapon_type": "spear", "excellent": true, "max_stack": 1, "color": Color(0.9, 0.85, 0.55, 1.0),
		"weapon_stats": {"damage": 16, "cooldown": 0.75, "range_offset": 55, "area_size": Vector2(70, 40), "knockback_min": 40.0, "knockback_max": 70.0, "icon_size": Vector2(84, 8), "icon_color": Color(0.9, 0.85, 0.55), "icon_offset": 16.0},
...
const SET_DEFS = {
	...
	"bulwark": {
		...
		"bonus_desc": "+35 Max HP, +10% Melee DMG + TEMPER: every blow you weather hardens the next you land (+6% melee per stack, up to 3)",
		"weapon": "wpn_claymore",
	...
	"windstalker": {
		...
		"bonus_desc": "+12% Bow DMG, +8% Move Speed + DEADEYE: stand still a breath and your next volley is a CERTAIN crit",
		"weapon": "wpn_recurve",
	...
	"runeweave": {
		...
		"bonus_desc": "+30 Max Mana, +50% Mana Regen + SOULTHREAD: a tenth of your wand damage returns as life",
		"weapon": "wpn_scepter",

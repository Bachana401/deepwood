...
const TREES = {
	"Sword": [
		...
		# --- The Wukong roads (2026-07-28): two Sword side-nodes off the spines,
		# same pattern as the Mage's Riftweaving. Mechanics live in player.gd.
		{"id": "sw_wk1", "branch": 0, "col": 1.5, "name": "Somersault Cut", "desc": "Press JUMP in mid-air to FLIP forward -- a flashing somersault that carries you through the fray, untouchable for a blink. (3s cooldown)", "tier": 2, "cost": 2, "prereq": "sw_b1", "materials": {"slime": 2}, "road": true, "effect": {"somersault": 1.0}},
		{"id": "sw_wk2", "branch": 1, "col": 3.5, "name": "The Immovable Pillar", "desc": "HOLD DOWN on the ground to PLANT yourself: rooted like a pillar, +35% damage reduction, and your blade answers every 0.8s with a counter-arc on its own.", "tier": 3, "cost": 2, "prereq": "sw_g2", "materials": {"iron_shard": 2}, "road": true, "effect": {"pillar_stance": 1.0}},
	...
	"Archer": [
		...
		# --- The Wukong roads (2026-07-28): the hunter reads the sky and the eye.
		{"id": "ar_wk1", "branch": 0, "col": 1.5, "name": "The Golden Gaze", "desc": "Your arrows MARK what they strike (2.5s): a marked foe glows gold and takes +15% damage from everything that serves you.", "tier": 3, "cost": 2, "prereq": "ar_m2", "materials": {"iron_shard": 2}, "road": true, "effect": {"golden_gaze": 1.0}},
		{"id": "ar_wk2", "branch": 1, "col": 3.5, "name": "Cloud Step", "desc": "A THIRD jump: kick off a cloudlet in mid-air where nothing stands. The sky has stairs if you know where to tread.", "tier": 3, "cost": 2, "prereq": "ar_r2", "materials": {"iron_shard": 2}, "road": true, "effect": {"cloud_step": 1.0}},
	...
	"Mage": [
		...
		# --- The Wukong roads (2026-07-28): the word that stops, the hair that fights.
		{"id": "mg_wk1", "branch": 0, "col": 1.5, "name": "Stillness", "desc": "Your wand bolts carry the stopping word: 12% chance to hold a non-boss PERFECTLY STILL for 2.5s.", "tier": 3, "cost": 2, "prereq": "mg_e2", "materials": {"iron_shard": 2}, "road": true, "effect": {"stillness": 1.0}},
		{"id": "mg_wk2", "branch": 1, "col": 3.5, "name": "The Plucked Hair", "desc": "When enemies press close, a hair plucks itself free and stands as a MIRROR-MAGE (8s): it bolts what threatens you, then scatters. (20s cooldown)", "tier": 3, "cost": 2, "prereq": "mg_s2", "materials": {"iron_shard": 2}, "road": true, "effect": {"hair_clone": 1.0}},
		...
		{"id": "mg_p1", "branch": 2, "col": 5.5, "name": "Riftweaving", "desc": "Press Z: open an orange rift where you stand; press Z again elsewhere for the blue one. Step into either to exit the other. While BOTH stand, your mana drains FAST.", "tier": 2, "cost": 2, "prereq": "mg_m1", "materials": {"slime": 2}, "road": true, "effect": {"portal_unlock": 1.0}},
		{"id": "mg_p2", "branch": 2, "col": 5.5, "name": "Stable Rifts", "desc": "The doors learn to hold themselves: -40% rift mana drain.", "tier": 4, "cost": 2, "prereq": "mg_p1", "materials": {"ember_crystal": 1}, "road": true, "effect": {"portal_drain_cut": 0.40}},
		{"id": "mg_p3", "branch": 2, "col": 5.5, "name": "Master of Doors", "desc": "-30% more rift drain, and opening a rift costs half.", "tier": 6, "cost": 2, "prereq": "mg_p2", "materials": {"void_essence": 1}, "road": true, "effect": {"portal_drain_cut": 0.30, "portal_open_cut": 0.5}},
		# --- Telepathy (dev request 2026-07-20): the village fog's answer.
		# Away from home the player knows NOTHING of the village -- this
		# mid-game node is what lifts the fog: meter, diary, every cry, and
		# the Watchtower's bell reach the mage anywhere, even the deep.
		{"id": "mg_t1", "branch": 2, "col": 6.5, "name": "Telepathy", "desc": "Your mind reaches home from ANYWHERE: the village's morale, its diary (L), and its every cry arrive wherever you stand — even in the deep. Without it, distance is ignorance.", "tier": 4, "cost": 2, "prereq": "mg_m2", "materials": {"ember_crystal": 2}, "road": true, "effect": {"telepathy": 1.0}},
	...
	"Shadow Monarch": [
		...
		# --- The Wukong roads (2026-07-28): even his army learned the trick.
		{"id": "nc_wk1", "branch": 0, "col": 1.5, "name": "The Splitting Dark", "desc": "A falling shade TEARS ITSELF IN TWO: both halves fight on at half strength for a while. The army refuses arithmetic.", "tier": 3, "cost": 2, "prereq": "nc_l2", "materials": {"iron_shard": 2}, "road": true, "effect": {"clone_burst": 1.0}},
		...
		# --- Wukong road: the sky is his road too (grants BOTH air tricks).
		{"id": "nc_wk2", "branch": 2, "col": 5.5, "name": "The Sky Is His Road", "desc": "The Monarch takes the air as territory: a THIRD jump off a shadow-cloud AND the mid-air somersault, both at once.", "tier": 3, "cost": 2, "prereq": "nc_a2", "materials": {"iron_shard": 2}, "road": true, "effect": {"monarch_air": 1.0}},

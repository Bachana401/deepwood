...
- **The Cottage — the pair-home.** A **Cottage holds exactly one PAIR** (two villagers). Once two villagers are paired into a cottage they **cannot be separated — only death parts them**, and the cottage stays **occupied for as long as both live.** (When one dies, the survivor is single again and may re-pair; the freed cottage can take a new pair.) The Cottage is also where mating happens (§5.4 lifecycle) — home and cradle are the same building.
- **Built, not free.** Cottages cost construction materials and are raised by the Builderhouse (or by hand early) — so **housing capacity is something you must keep building**, and it ties straight into the Mine→stone / Builderhouse chain (§5.7). More people ⇒ more cottages ⇒ more materials ⇒ more Builder pressure.
- **The Tavern is temporary lodging only** (§5.2): rescued/newcomer/single villagers live in the Tavern *until* they're housed in a cottage. The Tavern is the waiting room; the cottage is home.
- 🟡 Open (§12): where **single/unpaired** adults and **children** sleep (proposal: the Tavern dorms singles, children live in their parents' cottage until adult); whether a cottage can be upgraded to hold a family (parents + young kids) or kids overflow to the Tavern; do **Warriors** get cottages too (see §12 #17).
